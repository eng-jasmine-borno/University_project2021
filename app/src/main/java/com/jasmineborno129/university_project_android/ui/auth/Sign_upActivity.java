...
import com.jasmineborno129.university_project_android.databinding.ActivitySignUpBinding;
...
public class Sign_upActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.login.setOnClickListener(v->{
            startActivity(new Intent(Sign_upActivity.this, com.jasmineborno129.university_project_android.ui.auth.LoginActivity.class));
        });
