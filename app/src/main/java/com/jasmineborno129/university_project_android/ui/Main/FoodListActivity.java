...
import com.jasmineborno129.university_project_android.adapters.FoodAdapter;
import com.jasmineborno129.university_project_android.databinding.ActivityFoodListBinding;
    ...
    private void initUI(){
        adapter = new FoodAdapter(my_records, new FoodAdapter.FoodListener() {
            ...
            public void onEditClickListener(Context context, String food_id) {
                Intent intent = new Intent(context, com.jasmineborno129.university_project_android.ui.Main.AddFoodActivity.class);
